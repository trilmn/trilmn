    ...
    <SectionDivider>Current</SectionDivider>
		...
		<div className="px-4">
			<div className="flex items-center">
				...
				<div>
					<h4 className="text-base font-bold uppercase flex items-center"><a href="https://www.quaestor.com" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-400 transition-fast" title="Go to Quaestor's website"><span className="mr-2">Quaestor</span><svg height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13.8281 10.172C13.078 9.42213 12.0607 9.00087 11.0001 9.00087C9.93942 9.00087 8.92219 9.42213 8.17208 10.172L4.17208 14.172C3.79004 14.541 3.48531 14.9824 3.27567 15.4704C3.06604 15.9584 2.95569 16.4833 2.95108 17.0144C2.94646 17.5455 3.04767 18.0722 3.24879 18.5638C3.44992 19.0554 3.74693 19.502 4.1225 19.8776C4.49807 20.2532 4.94468 20.5502 5.43626 20.7513C5.92785 20.9524 6.45457 21.0536 6.98569 21.049C7.5168 21.0444 8.04168 20.9341 8.5297 20.7244C9.01771 20.5148 9.45909 20.2101 9.82808 19.828L10.9301 18.727M10.1721 13.828C10.9222 14.5779 11.9394 14.9992 13.0001 14.9992C14.0607 14.9992 15.078 14.5779 15.8281 13.828L19.8281 9.82801C20.5567 9.0736 20.9599 8.06319 20.9508 7.01441C20.9417 5.96562 20.521 4.96237 19.7794 4.22074C19.0377 3.4791 18.0345 3.05843 16.9857 3.04932C15.9369 3.0402 14.9265 3.44338 14.1721 4.17201L13.0721 5.27201" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
			...
			<p className="mt-5">Working remotely with the team in San Francisco due to <a href="https://www.worldometers.info/coronavirus/?" className="underline hover:text-blue-400 transition-fast">COVID-19</a> - Destiny recalled, being the 4th member again. We start things almost from scratch. Quaestor simplifies investor updates, facilitates collaboration, and enables founders to fully engage their network.</p>
		</div>
		...
		<div className="px-4">
			<div className="flex items-center">
				...
				<div>
					<h4 className="text-base font-bold uppercase flex items-center"><a href="https://www.anduintransact.com/" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-400 transition-fast" title="Go to Anduin's website"><span className="mr-2">Anduin Transactions</span><svg height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13.8281 10.172C13.078 9.42213 12.0607 9.00087 11.0001 9.00087C9.93942 9.00087 8.92219 9.42213 8.17208 10.172L4.17208 14.172C3.79004 14.541 3.48531 14.9824 3.27567 15.4704C3.06604 15.9584 2.95569 16.4833 2.95108 17.0144C2.94646 17.5455 3.04767 18.0722 3.24879 18.5638C3.44992 19.0554 3.74693 19.502 4.1225 19.8776C4.49807 20.2532 4.94468 20.5502 5.43626 20.7513C5.92785 20.9524 6.45457 21.0536 6.98569 21.049C7.5168 21.0444 8.04168 20.9341 8.5297 20.7244C9.01771 20.5148 9.45909 20.2101 9.82808 19.828L10.9301 18.727M10.1721 13.828C10.9222 14.5779 11.9394 14.9992 13.0001 14.9992C14.0607 14.9992 15.078 14.5779 15.8281 13.828L19.8281 9.82801C20.5567 9.0736 20.9599 8.06319 20.9508 7.01441C20.9417 5.96562 20.521 4.96237 19.7794 4.22074C19.0377 3.4791 18.0345 3.05843 16.9857 3.04932C15.9369 3.0402 14.9265 3.44338 14.1721 4.17201L13.0721 5.27201" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</a></h4>
			...
			<p className="mt-4">Some stuffs i wrote:</p>
		</div>
		...
		<SectionDivider>Past</SectionDivider>
